...
// ------------------------------------------------------------------
// last updated: <2024-February-28 17:31:36>
...
if (origResponse.access_token) {
  ...
  ["issued_at", "refresh_token_issued_at"].forEach(
  ...
  ["expires_in", "refresh_token_expires_in", "refresh_count"].forEach(
    function convertExpires(prop) {
      if (origResponse[prop]) {
